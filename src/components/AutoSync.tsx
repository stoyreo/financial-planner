 ...
 * retirement / tax / scenarios / activeScenarioId), debounces for a short
 * period and then calls saveUserNamespaceAsync() so the change is persisted
 * both to localStorage AND to the server file (data/user-*.json).
 *
